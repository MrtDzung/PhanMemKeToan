...
public class GlobalExceptionHandler(ILogger<GlobalExceptionHandler> logger) : IExceptionHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var (statusCode, errorCode, extras) = exception switch
        {
            ...
            TenantDbOfflineException tdoe => (503, "TENANT_DB_OFFLINE", (object?)new { tenant = tdoe.TenantName }),
            CompanyNotAccessibleException => (403, "COMPANY_NOT_ACCESSIBLE", (object?)null),
            TempTokenExpiredException => (401, "TEMP_TOKEN_EXPIRED", (object?)null),
            TokenExpiredException => (401, "TOKEN_EXPIRED", (object?)null),
            TokenRevokedException => (401, "TOKEN_REVOKED", (object?)null),
            UnauthorizedException ue => (401, ue.ErrorCode, (object?)null),
